...
Name|Description
----|-----------
[SecureBucket](#psconstructs-securebucket)|CNXC Secure S3 Bucket, based on @aws-cdk/aws-s3 Bucket.



## class SecureBucket  <a id="psconstructs-securebucket"></a>
...
```ts
new SecureBucket(scope: Construct, id: string, attrs: BucketProps)
```
...
* **attrs** (<code>[BucketProps](#aws-cdk-aws-s3-bucketprops)</code>)  A `BucketProps` object (compatible with s3.BucketProps).
